...
author: "Actual tweets from the @guardian account, but all data are FAKE DATA"
date: "Today's Date"
output:
  slidy_presentation: default
  html_document: default
params:
  file: "sample_tweets_file.csv"
  words: !r c("news", "sports", "politics", "economy", "weather", "football", "uk", "us")
---
...
```
* actual tweets but FAKE DATA for demonstration only

## Most Used Words - absolute and weighted frequency

```{r word_freq, warning=FALSE}
tweets_freq <- word_frequency(tweets_df[c(3,5)], rm_words = c(stopwords_en, "|", "   "))
