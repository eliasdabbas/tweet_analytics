...
1. Download the file either from:  
 [Twitter analytics](http://analytics.twitter.com) (click on the **Tweets** tab) _OR_  
...
3. This document is meant to be a starting point in your analysis of your tweet activity. There are more than forty columns, and the possible combinations are endless. I have chosen the main metrics that give an overview of: 
(a) tweet activity: daily, monthly, day of week, and hourly
(b) word usage: all the words that are used, weighted and absolute frequency, together with the target words of your choice
(c) hashtags and mentions: count, frequency, and the top ones that you are using

4. Encoding might be an issue especially with emoticons, and if you are using different languages. A quick fix that works for English, is a line that converts the encoding of the tweets text. This is in the fist chunk, and you will simply have to uncomment the line  
